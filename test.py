...
class DetectionPredictor(BasePredictor):
    # The rest of the DetectionPredictor class remains unchanged
...
def predict(cfg):
    # Modify cfg for license plate detection
    cfg.model = "yolov8n.pt"  # Specify your model here
    cfg.imgsz = check_imgsz(cfg.imgsz, min_dim=2)  # check image size
    cfg.source = 0  # Use 0 for webcam
